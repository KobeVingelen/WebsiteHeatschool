  ...
  return (
    ...
    >
      <div className="bg-white/5 backdrop-blur-md rounded-lg p-4 sm:p-6 border border-white/10 hover:border-hot-pink/20 transition-colors">
        <h3 className="text-lg sm:text-xl font-semibold mb-2 text-hot-pink">Location</h3>
      ...
      <div className="bg-white/5 backdrop-blur-md rounded-lg p-4 sm:p-6 border border-white/10 hover:border-hot-pink/20 transition-colors">
        <h3 className="text-lg sm:text-xl font-semibold mb-2 text-hot-pink">
          Date & Time
        </h3>
        <p className="text-sm sm:text-base text-white">
          Friday, May 9th
      ...
      <div className="bg-white/5 backdrop-blur-md rounded-lg p-4 sm:p-6 border border-white/10 hover:border-hot-pink/20 transition-colors sm:col-span-2 lg:col-span-1">
        <h3 className="text-lg sm:text-xl font-semibold mb-2 text-hot-pink">Tickets</h3>
        <TicketButton />
      </div>
    </div>
  );
  ...
  return (
    <section className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 pt-16 sm:pt-24">
      <div className="max-w-7xl mx-auto w-full">
        <div className="flex flex-col justify-center items-center text-center fade-in animate-in space-y-4">
