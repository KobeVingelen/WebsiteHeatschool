  ...
  return (
    <div className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-12`}>
      ...
      <div className="w-full lg:w-1/2 space-y-6 px-4 lg:px-8">
        <div className={`w-16 h-[2px] bg-heat-pink ${isEven ? '' : 'ml-auto'}`} />
        <div className="space-y-4">
          <h2 className="text-2xl md:text-2xl font-bold text-white tracking-wider">{name}</h2>
          <div className="flex items-center text-heat-pink">
